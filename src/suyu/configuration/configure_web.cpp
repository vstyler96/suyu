...
void ConfigureWeb::RetranslateUI() {
    ...
    ui->telemetry_learn_more->setText(
        tr("<a href='https://suyu-emu.org/help/feature/telemetry/'><span style=\"text-decoration: "
           "underline; color:#039be5;\">Learn more</span></a>"));

    ui->web_signup_link->setText(
        tr("<a href='https://profile.suyu-emu.org/'><span style=\"text-decoration: underline; "
           "color:#039be5;\">Sign up</span></a>"));

    ui->web_token_info_link->setText(
        tr("<a href='https://suyu-emu.org/wiki/suyu-web-service/'><span style=\"text-decoration: "
