...
void KeyManager::ReloadKeys() {
    ...
    if (Settings::values.use_dev_keys) {
        dev_mode = true;
        LoadFromFile(suyu_keys_dir / "dev.keys_autogenerated", false);
        LoadFromFile(suyu_keys_dir / "dev.keys", false);
    } else {
        dev_mode = false;
        LoadFromFile(suyu_keys_dir / "prod.keys_autogenerated", false);
        LoadFromFile(suyu_keys_dir / "prod.keys", false);
    }

    LoadFromFile(suyu_keys_dir / "title.keys_autogenerated", true);
    LoadFromFile(suyu_keys_dir / "title.keys", true);
    LoadFromFile(suyu_keys_dir / "console.keys_autogenerated", false);
...
void KeyManager::WriteKeyToFile(KeyCategory category, std::string_view keyname,
    ...
    const auto path = suyu_keys_dir / filename;
    ...
    if (add_info_text) {
        void(file.WriteString(
            "# This file is autogenerated by suyu\n"
